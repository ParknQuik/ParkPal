...
function statusRecords() {
  ...
  return [
    record({
      ...
      pri: 'always',
      d: '2026-07-16',
      txt: 'Readiness 95/100. PR #179 stabilized native mobile Google Sign-In with passing GitHub checks. Evidence: PR #179 backend/web/mobile/security/quality/validation checks passed; focused local backend Google auth 9/9, mobile AuthScreen 12/12, mobile TypeScript, and env check passed. Gaps: beta/deployment evidence and deployment health recheck.',
    ...
    record({
      ...
      pri: 'always',
      d: '2026-07-16',
      txt: 'Local-first dev remains active. PR #179 stabilized native mobile Google Sign-In after PR #173 hit-rate scanning, PR #175 compact mirrors, and PR #177 retrieval-miss routing coverage. Backend Cloud Run health recheck is a future deployment gate, not current stabilization.',
    ...
    record({
      ...
      pri: 'always',
      d: '2026-07-16',
      txt: 'GitHub backend, web, mobile, security, quality, validation, PR-size, branch, and mobile env checks passed for PR #179. Local focused evidence: backend Google auth Jest 9/9 with Docker Postgres/Redis access, mobile AuthScreen Jest 12/12, mobile TypeScript, mobile env:check, and git diff --check passed.',
    ...
    record({
      ...
      pri: 'always',
      d: '2026-07-16',
      txt: 'Testing: PR #179 Google Sign-In stabilization is green locally and in GitHub checks. Redis remains deferred. Backend Cloud Run and web health need re-verification before production. Mobile app-store distribution waits for beta scope.',
      refs: ['STATUS_REPORT.md', 'docs/BETA_READINESS_CHECKLIST.md'],
    ...
    record({
      ...
      pri: 'high',
      d: '2026-07-16',
      txt: 'No open PRs against dev as verified on July 16. Recently merged: #179 mobile Google Sign-In stabilization, #177 retrieval-miss routing coverage, #175 compact status mirrors, #174 status reconciliation, #173 knowledge hit-rate scanner.',
      refs: ['STATUS_REPORT.md'],
    ...
    record({
      ...
      pri: 'high',
      d: '2026-07-16',
      txt: 'No current P0 local blocker documented. Key items: PR #179 Google Sign-In checks passed, backend local full suite remains 494/496, Redis deferred, deployment health needs beta-readiness recheck, and mobile distribution waits for beta scope.',
      refs: ['STATUS_REPORT.md'],
    ...
    record({
      ...
      pri: 'high',
      d: '2026-05-25',
      txt: 'Evidence table: PR queue clear, git hygiene passed, web tests 85/85, mobile tests 56/56, mobile TypeScript passed, backend 494/496 locally, Cloud Run health 503 degraded (May 17).',
