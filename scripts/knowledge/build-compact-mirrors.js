...
function statusRecords() {
  ...
  return [
    record({
      ...
      pri: 'always',
      d: '2026-05-25',
      txt: 'Readiness 95/100. Local evidence: web 85/85, backend 494/496 (2 skipped), mobile 56/56, mobile TypeScript passing. Gaps: beta/deployment evidence needed. Redis deferred. Mobile distribution pending beta scope. Deployment health needs re-verification.',
    ...
    record({
      ...
      pri: 'always',
      d: '2026-05-25',
      txt: 'Web 85/85 locally, backend 494/496 (2 skipped) locally, mobile 56/56 locally, and mobile TypeScript passing. GitHub backend, web, mobile, security, and quality checks passed for PR #161.',
    ...
    record({
      ...
      pri: 'high',
      d: '2026-05-25',
      txt: 'No open PRs against dev as verified on May 25. Recently merged: #161, #160, #153, #158, #157, #156, #155, #154, #151.',
      refs: ['STATUS_REPORT.md'],
    ...
    record({
      ...
      pri: 'high',
      d: '2026-05-25',
      txt: 'No current P0 local blocker documented. Key items: backend local suite refreshed (494/496), Redis deferred, mobile distribution waits for beta scope. Backend tests improved from 50/271 to 494/496.',
      refs: ['STATUS_REPORT.md'],
