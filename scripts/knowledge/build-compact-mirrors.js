...
function statusRecords() {
  ...
  return [
    record({
      ...
      pri: 'always',
      d: '2026-06-01',
      txt: 'Readiness 95/100. PR #173 added knowledge hit-rate scanning with passing GitHub checks. Evidence: web 85/85, backend 494/496 (2 skipped), mobile 90/90, mobile TypeScript passing. Gaps: beta/deployment evidence and deployment health recheck.',
    ...
    record({
      ...
      pri: 'always',
      d: '2026-06-01',
      txt: 'Local-first dev remains active. PR #173 added hit-rate scanning; compact mirror freshness is the immediate tooling follow-up. Backend Cloud Run health recheck is a future deployment gate, not current stabilization.',
    ...
    record({
      ...
      pri: 'always',
      d: '2026-06-01',
      txt: 'GitHub backend, web, mobile, security, quality, validation, PR-size, and branch checks passed for PR #173. Local evidence: mobile Jest 90/90 and TypeScript passed on June 1; backend 494/496 and web 85/85 remain the latest broader local suites.',
    ...
    record({
      ...
      pri: 'always',
      d: '2026-06-01',
      txt: 'Testing: compact mirror freshness is the immediate tooling follow-up. Redis remains deferred. Backend Cloud Run and web health need re-verification before production. Mobile app-store distribution waits for beta scope.',
      refs: ['STATUS_REPORT.md', 'docs/BETA_READINESS_CHECKLIST.md'],
    ...
    record({
      ...
      pri: 'high',
      d: '2026-06-01',
      txt: 'No open PRs against dev as verified on June 1. Recently merged: #174 status reconciliation, #173 knowledge hit-rate scanner, #171 mobile signup validation, #165 account standing, #163 web auth tests, #161 web Vitest timeouts.',
      refs: ['STATUS_REPORT.md'],
    ...
    record({
      ...
      pri: 'high',
      d: '2026-06-01',
      txt: 'No current P0 local blocker documented. Key items: compact mirror freshness follow-up, backend local suite refreshed (494/496), Redis deferred, and mobile distribution waits for beta scope. Backend tests improved from 50/271 to 494/496.',
      refs: ['STATUS_REPORT.md'],
