          ...
          <View style={styles.zoneAvailability}>
            <View style={styles.availInfoRow}>
              <View style={[styles.availBadge, getAvailabilityStyle()]}>
                <Text style={styles.availBadgeText}>
                  {availableSlots}/{totalSlots} open
                </Text>
              </View>
              {circlingTime != null && (
            ...
            <View style={styles.progressContainer}>
              <View style={styles.progressTrack}>
                <View
                  style={[
                    styles.progressFill,
                    {
                      width: `${Math.min(occupancyPercentage ?? 0, 100)}%`,
                      backgroundColor:
                        (occupancyPercentage ?? 0) >= 80
                          ? '#ef4444'
                          : (occupancyPercentage ?? 0) >= 50
                            ? '#f59e0b'
                            : '#10b77f',
                    },
                  ]}
              ...
              <Text style={styles.progressLabel}>
                {occupancyPercentage != null ? `${occupancyPercentage}% occupied` : 'No data'}
              </Text>
            </View>
          </View>
        )}
