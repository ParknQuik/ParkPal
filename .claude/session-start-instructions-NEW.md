...
**MANDATORY:** All code changes must follow `CODE_GUIDELINES.md`
...
- `fix(ci): resolve GitHub Actions errors`
- `docs(readme): update installation steps`

**ALWAYS add co-author for AI assistance:**
```
...
**GitHub Actions WILL BLOCK merges if PR title is invalid.**
...
3. Ask for explicit confirmation: "Ready to commit these changes?"
4. Wait for user approval before running `git commit`
...
- **Branches:** Type-based naming

**See `CODE_GUIDELINES.md` for complete standards.**
